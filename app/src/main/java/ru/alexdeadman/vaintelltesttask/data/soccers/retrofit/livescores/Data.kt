...
data class Data (
  ...
  @SerializedName("standings"      ) var standings     : Standings?     = Standings(),
  @SerializedName("assistants"     ) var assistants    : Assistants?    = Assistants(),
  @SerializedName("coverage"       ) var coverage      : Coverage?      = Coverage(),
  @SerializedName("weather_report" ) var weatherReport : WeatherReport? = WeatherReport()
